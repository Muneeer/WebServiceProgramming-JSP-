...
<form action="process_form4.jsp" name="member" method="post">
	...
	<p> Hobbies : Reading<input type="checkbox" name="hobby1" checked>
			  	  Movies<input type="checkbox" name="hobby2">
			  	  Travel<input type="checkbox" name="hobby3"></p>
